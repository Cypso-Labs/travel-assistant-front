...
<main className="container mx-auto mt-10 px-4">
      ...
      <form className="bg-white shadow-md rounded-lg p-8 border-2 border-green-500">
        ...
        <div className="flex flex-wrap md:flex-nowrap justify-between gap-4 mb-4">
          ...
          <div className="w-full md:w-1/2">
            ...
            />
            <p className="text-sm text-gray-500">Convert Global currency to rupees</p>
          </div>
        </div>
  ...
  <div className="container mx-auto flex flex-wrap justify-between items-start px-6 lg:px-16 space-y-6 md:space-y-0">
    ...
    <div className="w-full md:w-1/3 space-y-4">
      <div className="bg-gray-500 rounded-full w-10 h-10"></div> {/* Placeholder for logo */}
    ...
    <div className="w-full md:w-1/3 space-y-4">
      ...
      <ul className="space-y-2">
        <li>
          <a href="/" className="hover:text-green-500 transition-all duration-200">
            Home
          </a>
        </li>
        <li>
          <a href="/about" className="hover:text-green-500 transition-all duration-200">
            About Us
          </a>
        </li>
        <li>
          <a href="/itinerary" className="hover:text-green-500 transition-all duration-200">
            Itinerary
          </a>
        </li>
        <li>
          <a href="/events" className="hover:text-green-500 transition-all duration-200">
            Events
          </a>
        </li>
        <li>
          <a href="/recipes" className="hover:text-green-500 transition-all duration-200">
            Recipe
          </a>
        </li>
      </ul>
